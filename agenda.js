...
class agenda {
    ...
    visualizarevento() {
        ...
        for (let i = 0; i < this.evento.length; i++) {
            console.log("o nome do evento é: " + this.evento[i].nome + " na data " + this.evento[i].data + "no horario :" + this.evento[i].horario);
        }
    }
    removerEvento() {
...
let evento1 = new evento("fazer compras", "06/09", 18);
let evento2 = new evento("Ir ao salao", "10/09", 14);
let evento3 = new evento("Ir ao dentista", "15/09", 15);
